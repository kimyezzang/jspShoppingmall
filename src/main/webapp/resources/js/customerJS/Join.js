...
function signInCheck(){
	...
	else if(idchk.test(document.joinform.id.value) != 1){
		alert("아이디를 소문자 숫자 조합으로 6자이상 20자이하 입력하세요.");
		document.joinform.id.focus();
		return false;		
...
function confirmId(){
	...
	// 중복확인 페이지 open
	var url = "/jsp_pj_marketyezzang/confirmIdAction.do?id=" + document.joinform.id.value;
